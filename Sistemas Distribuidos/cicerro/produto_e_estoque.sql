...
--
-- Host: localhost
-- Generation Time: 25-Jun-2017 às 19:15
...
(1, 'Teste teste 1', 4, 10.5, 1, 3),
(2, 'Achocolatado Dois Frades 200g', 1, 10.5, 2, 8),
(3, 'Açai', 7, 10.5, 3, NULL),
(4, 'Teste gestor produto', 5, 1.99, 3, NULL);
