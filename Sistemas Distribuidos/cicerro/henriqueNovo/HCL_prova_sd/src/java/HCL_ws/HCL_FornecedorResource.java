 ...
 */
@Path("fornecedor")
public class HCL_FornecedorResource {
    ...
    public List<HCL_Fornecedor> getJson() {
        //TODO return proper representation object
        //throw new UnsupportedOperationException();
        
        System.out.println("Teste get fornecedor");
        return new HCL_FornecedorBO().getHCL_Fornecedores();
...
@PUT
    ...
    public void putJson(String HCL_content) {
          ...
          System.out.println("Teste put fornecedor");
      ...
      //   System.out.println("Teste:"+c.getHCL_nome()+"-"+c.getHCL_Cpf()+"-"+c.getHCL_Email()+"-"+c.getHCL_Ano());
        ...
        if(HCL_int_nroLinha2F ==1){
          ...
          HCL_Fornecedor HCL_forn = g.fromJson(HCL_content, HCL_Fornecedor.class);
          //System.out.println("Teste:"+c.getHCL_nome()+"-"+c.getHCL_Cpf()+"-"+c.getHCL_Email()+"-"+c.getHCL_Ano());
          new HCL_FornecedorBO().HCL_edita(HCL_int_nroLinhaF, HCL_forn);
        } 
      ...
      //   System.out.println("All"+content);
        //System.out.println("Teste:"+c.getHCL_nome()+"-"+c.getHCL_Cpf()+"-"+c.getHCL_Email()+"-"+c.getHCL_Ano());
         new HCL_FornecedorBO().HCL_salva(HCL_forn);
        }           
         
        if(HCL_int_nroLinha2F ==3) {
            
            
            new HCL_FornecedorBO().HCL_exclui(HCL_int_nroLinhaF);
